...
<div class="section-content health-fade-in">
    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                Edite abaixo seu Link <i class="bi bi-question-square-fill"onclick="ajudaVideosEditar()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
    ...
    <div class="form-row">
            ...
            <input class="health-input" data-step="2" minlength="5" maxlength="150" type="text" name="video_titulo" value="<?php echo $descricao; ?>" required>
            <label class="health-label">Link do Video</label>
            <input class="health-input" data-step="3" minlength="5" maxlength="1500" type="text" name="video_link" value="<?php echo $link_youtube; ?>" required>
                <input type="hidden" name="video_id" value="<?php echo $id; ?>" />
                <input type="hidden" name="id_job" value="editar_link" />
            <div data-step="4"><button class="health-btn health-btn-success" type="submit"><i class="bi bi-pencil"></i> Editar</button></div>
