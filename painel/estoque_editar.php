...
<div class="section-content health-fade-in">
    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                <i class="bi bi-box"></i>
                Editar Produtos <i class="bi bi-question-square-fill"onclick="ajudaEstoqueProdutosEditar()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
    ...
    <div class="form-row">
            ...
            <input class="health-input" data-step="2" minlength="5" maxlength="100" type="text" name="produto" value="<?php echo $produto; ?>" required>
            <label class="health-label">Estoque Minimo</label>
            <input class="health-input" data-step="3" min="1" max="9999" type="number" name="produto_minimo" value="<?php echo $minimo; ?>" required>
