...
<div class="section-content health-fade-in">
    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                <i class="bi bi-box"></i>
                Cadastrar Produtos <i class="bi bi-question-square-fill"onclick="ajudaEstoqueProdutos()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
    ...
    <div class="form-row">
            ...
            <input class="health-input" data-step="2" minlength="5" maxlength="100" type="text" name="produto" placeholder="Produto" required>
            <label class="health-label">Estoque Minimo</label>
            <input class="health-input" data-step="3" min="1" max="9999" type="number" name="produto_minimo"  required>
            <label class="health-label">Unidade de Medida</label>
            <select class="health-select" data-step="4" name="produto_unidade" required>
    ...
    <table data-step="6" class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Editar"><a href="javascript:void(0)" onclick='window.open("estoque_editar.php?id=<?php echo $id ?>","iframe-home")'><button class="health-btn health-btn-primary btn-mini"><i class="bi bi-pencil"></i> Editar</button></a></td>
                    <td data-label="Excluir"><a href="javascript:void(0)" onclick='window.open("estoque_excluir.php?id=<?php echo $id ?>","iframe-home")'><button class="health-btn health-btn-danger btn-mini"><i class="bi bi-trash"></i> Excluir</button></a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
