    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                Modelos Anamneses <i class="bi bi-question-square-fill"onclick="ajudaAnamneses()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
            <p class="health-card-subtitle">
                Veja, Edite e Exclua todos os seus modelos de anamneses abaixo:
            </p>
        </div>
    </div>
    ...
    <table data-step="2" class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Editar"><a href="javascript:void(0)" onclick='window.open("anamnese_criar_modelo.php?id_modelo=<?php echo $id_modelo ?>","iframe-home")'><button class="health-btn health-btn-primary btn-mini"><i class="bi bi-pencil"></i> Editar</button></td>
