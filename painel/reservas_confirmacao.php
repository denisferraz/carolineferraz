    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                Confirmação Consulta <i class="bi bi-question-square-fill"onclick="ajudaConsultaConfirmacao()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
            <p class="health-card-subtitle">
                Confirme os dados para enviar a confirmação desta consulta
            </p>
        </div>
    </div>
...
<div data-step="1" class="form-section health-fade-in">
            ...
            <div data-step="7"><button class="health-btn health-btn-primary" type="submit"><i class="bi bi-check-lg"></i> Enviar Conirmação</button></div>
