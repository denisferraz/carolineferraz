...
<body>
  <form data-step="1" id="form-modelo-anamnese" class="card" enctype="multipart/form-data">
    <h2><?= $modelo_id ? "Editar Modelo de Anamnese" : "Criar Ficha de Anamnese" ?> <i class="bi bi-question-square-fill"onclick="ajudaAnamnese()"title="Ajuda?"style="color: darkred; cursor: pointer; font-size: 25px;"></i></h2>
