    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                <?= $modelo_id ? "Editar Modelo de Anamnese" : "Criar Ficha de Anamnese" ?> <i class="bi bi-question-square-fill"onclick="ajudaAnamnese()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
            <p class="health-card-subtitle">
                Confirme os dados para salvar este modelo de anamnese
        </div>
    </div>
    
  <form data-step="1" id="form-modelo-anamnese" class="card" enctype="multipart/form-data">
