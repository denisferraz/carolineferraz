...
<div class="section-content health-fade-in">
    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                Cadastrar Serviço <i class="bi bi-question-square-fill"onclick="ajudaServicosCadastrar()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
    ...
    <div class="form-row">
                ...
                <label class="health-label">Descrição Serviços</label>
                <textarea class="health-input" data-step="2" name="tratamento_descricao" class="textarea-custom" rows="5" cols="43" required></textarea><br><br>

                <input type="hidden" name="id_job" value="lancar_tratamento" />
                <div data-step="3"><button class="health-btn health-btn-success" type="submit"><i class="bi bi-check-lg"></i> Cadastrar Serviço</button></div>
    ...
    <table data-step="4" class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Editar"><a href="javascript:void(0)" onclick='window.open("tratamentos_editar.php?id=<?php echo $id ?>","iframe-home")'><button class="health-btn health-btn-primary btn-mini"><i class="bi bi-pencil"></i> Editar</button></a></td>
                    <td data-label="Excluir"><a href="javascript:void(0)" onclick='window.open("tratamentos_excluir.php?id=<?php echo $id ?>","iframe-home")'><button class="health-btn health-btn-danger btn-mini"><i class="bi bi-trash"></i> Excluir</button></a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table></div>
