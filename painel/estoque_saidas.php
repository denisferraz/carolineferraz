...
<body>
    ...
    <table>
            ...
            <tbody>
                <?php
                $query = $conexao->prepare("SELECT * FROM estoque WHERE token_emp = '{$_SESSION['token_emp']}' AND id >= :id AND tipo = 'Saida' ORDER BY data_entrada ASC");
                $query->execute(['id' => 1]);
