    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                Modelos Prontuários <i class="bi bi-question-square-fill"onclick="ajudaProntuarios()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
            <p class="health-card-subtitle">
                Veja, Edite e Exclua todos os seus modelos de prontuários abaixo:
            </p>
        </div>
    </div>
...
<div data-step="1" class="form-row">
    ...
    <table data-step="2" class="data-table">
            <thead>
                <tr>
                    <th>Criado em</th>
                    <th>Nome</th>
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td data-label="Criado em"><?php echo $criado_em; ?></td>
                    <td data-label="Nome"><?php echo $titulo; ?></td>
                    <td data-label="Editar"><a href="javascript:void(0)" onclick='window.open("prontuario_criar_modelo.php?id_modelo=<?php echo $id_modelo ?>","iframe-home")'><button class="health-btn health-btn-primary btn-mini"><i class="bi bi-pencil"></i> Editar</button></td>
                    <td data-label="Excluir">
                    <a href="javascript:void(0)" onclick="confirmarExclusao(<?php echo $id_modelo ?>)"><button class="health-btn health-btn-danger btn-mini"><i class="bi bi-trash"></i> Excluir</button></a>
                    </td>
