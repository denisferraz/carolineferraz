...
<body>
    ...
    <form class="form" action="acao.php" method="POST" onsubmit="exibirPopup()">
        <div data-step="1" class="card">
            <div class="card-top">
                <h2>Cadastrar Receita <i class="bi bi-question-square-fill"onclick="ajudaReceitaAdd()"title="Ajuda?"style="color: darkred; cursor: pointer; font-size: 25px;"></i></h2>
            </div>
            ...
            <br>
            <label>Titulo</label>
            <input data-step="3" type="text" minlength="5" maxlength="50" name="titulo" placeholder="Receita Médica" required>
            <label>Receita</label>
            ...
            <div data-step="5" class="card-group-red btn"><button type="submit">Registrar Receita</button></div>
            </div>
        </div>
    </form>
</body>
