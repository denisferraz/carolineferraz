...
<div class="section-content health-fade-in">
    ...
    <div class="health-card health-fade-in">
        <div class="health-card-header">
            <h1 class="health-card-title">
                ...
                Cadastrar Entrada de Estoque <i class="bi bi-question-square-fill"onclick="ajudaEstoqueProdutosEntradas()"title="Ajuda?"style="color: white; cursor: pointer; font-size: 25px;"></i>
            </h1>
            <p class="health-card-subtitle">
                Preencha os dados para cadastrar uma entrada de estoque
            </p>
        </div>
    </div>
    ...
    <div class="form-row">
            ...
            <label class="health-label">Data Entrada</label>
            <input class="health-input" data-step="2" type="date" name="data_lancamento" value="<?php echo $hoje; ?>" >

            <label class="health-label">Produto</label>
            <select class="health-select" data-step="3" name="produto" required>
            <?php
                ...
                <input class="health-input" data-step="4" type="number" name="produto_quantidade" min="1" max="9999" step="1" required>

                <label class="health-label">Valor (Total)</label>
                <input class="health-input" data-step="5" type="number" name="produto_valor" min="0.01" max="9999.00" step="0.01" required>

                <label class="health-label">Lote</label>
                <input class="health-input" data-step="6" type="text" name="produto_lote" minlength="1" maxlength="50" >

                <label class="health-label">Validade</label>
                <input class="health-input" data-step="7" type="date" name="produto_validade" value="<?php echo $hoje; ?>">

                <label class="health-label">Lançar em Despesa?</label>
                <select class="health-select" data-step="8" name="lancar_despesa" required>
                <option value="Sim">Sim</option>
                <option value="Não">Não</option>
                </select>
                 <br><br>           
            <input type="hidden" name="id_job" value="lancar_entrada" />
            <div data-step="9"><button class="health-btn health-btn-success" type="submit"><i class="bi bi-check-lg"></i> Confirmar</button></div>
