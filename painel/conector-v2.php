...
@import url(https://fonts.googleapis.com/css2?family=Open+Sans&display=swap);
  ...
  <body class="bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div class="bg-gradient-to-br from-primary-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center font-sans p-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-8 transition-all duration-300 transform hover:shadow-primary-200/50 hover:-translate-y-1">
          ...
          <div class="space-y-6" id="connection-form">
            <div>
              <label for="instance" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Clique abaixo para Gerar o QR Code</label>
              <input type="hidden" id="instance" value="<?php echo $client_id; ?>">
            </div>
    ...
    // Lista de mensagens que você quer ignorar
    const mensagensIgnoradas = [
        'Iniciando conexão com:',
        'Instância:'
    ];

    // Verifica se a mensagem é uma das que devem ser ignoradas
    if (mensagensIgnoradas.some(ignoreMsg => message.includes(ignoreMsg))) {
        return; // Se for para ignorar, não faz nada
    }
